...
Write-Information -InformationAction Continue -MessageData '[2/4] Re-hash nested Part 3 and Part 4 evidence artifacts'
...
foreach ($path in @($part4ReviewZip,$part4ReceiptPath,$part3ReviewZip,$part3ReceiptPath)) {
...
$combinedReceipt = [pscustomobject][ordered]@{
    ...
    part2=[pscustomobject][ordered]@{ requested=[int]$part4Result.inherited_part2_requested; validated=[int]$part4Result.inherited_part2_validated }
...
$expectedEntries = @('known-error-scan.json','part234-combined-certification-receipt.json','part3-transport-certification-receipt.json','part4-runner-certification-receipt.json') | Sort-Object
