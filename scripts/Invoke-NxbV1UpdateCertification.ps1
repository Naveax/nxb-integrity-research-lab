...
try {
    ...
    $finalUpdateStatePath=Get-NxbV1UpdateStatePath -UpdateRoot $updateRoot; $stageStatePath=Get-NxbV1UpdateStageStatePath -UpdateRoot $updateRoot
